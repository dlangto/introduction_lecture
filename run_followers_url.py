...
for followers_url_list in followers_url_list:
	...
	if os.path.exists(file_name):
		...
		try:
			print(user_id)
			response_text = github_session.get(followers_url_list).text
